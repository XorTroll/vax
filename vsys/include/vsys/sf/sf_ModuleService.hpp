...
#define VSYS_SF_MODULE_SERVICE_INTERFACE_INFO(C, H) \
...
AMS_SF_DEFINE_INTERFACE(ams::sf::vsys, IModuleService, VSYS_SF_MODULE_SERVICE_INTERFACE_INFO)
...
namespace vsys::sf {
    ...
    static_assert(ams::sf::vsys::IsIModuleService<ModuleService>);
