...
#define VSYS_SF_LOADER_SERVICE_INTERFACE_INFO(C, H) \
...
AMS_SF_DEFINE_INTERFACE(ams::sf::vsys, ILoaderService, VSYS_SF_LOADER_SERVICE_INTERFACE_INFO)
...
namespace vsys::sf {
    ...
    static_assert(ams::sf::vsys::IsILoaderService<LoaderService>);
